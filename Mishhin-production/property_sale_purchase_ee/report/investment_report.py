...
class investment_analysis_report(models.Model):
    ...
    def init(self):
        ...
        obj = self._cr.execute("""CREATE or REPLACE VIEW 
        investment_analysis_report as SELECT id,name,active,
        type_id,parent_id,purchase_price,acquisition_date,roi,return_period 
        FROM account_asset""")
